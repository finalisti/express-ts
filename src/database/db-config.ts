...
const checkData2 = `SELECT COUNT(*) AS count FROM authors`;
...
const exampleData2 = `INSERT INTO authors (name, email) VALUES
('User 1', 'user1@metropolia.fi'),
('User 2', 'user2@metropolia.fi');`;

export {filename, tables, checkData, checkData2, exampleData, exampleData2};
